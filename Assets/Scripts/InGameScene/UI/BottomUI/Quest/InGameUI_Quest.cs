...
namespace InGameScene.UI
{
    ...
    public class InGameUI_Quest : InGameUI_BottomUIBase
    {
        ...
        [SerializeField] private InGameUI_MainQuestItem MainQuestItem;
        ...
        {
            int MainQuestNumber = (StaticManager.Backend.GameData.UserData.MainQuestCount % 5 + 4) % 5 + 1;
            MainQuestItem.Init(StaticManager.Backend.Chart.Quest.Dictionary[MainQuestNumber]);
        ...
        public void UpdateUI(QuestType questType)
        {
            switch (questType)
            {
                ...
                case QuestType.DefeatEnemy:// 적 처리 퀘스트는 DefeatEenmyCount를 계산
                    ...
                    break;
                default:
                    MainQuestItem.UpdateMainQuestUI();
                    break;
            }
        }

        public QuestType GetMainQuestType()
        {
            return MainQuestItem.GetQuestType();
        }
