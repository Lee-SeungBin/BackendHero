...
namespace InGameScene.UI
{
    ...
    public class InGameUI_BottomUI : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            for (int i = 1; i < _bottomUIButtons.Length; i++)
            {
                int index = i;
        ...
        public void OnClickGrowth(bool active)
        {
            GrowthPopup.SetActive(GrowthPopup.activeSelf ? false : active);
        }
